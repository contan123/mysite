...
from .views import blog_detail,blogs_with_type,blog_list,blog_with_date,blog_project_list
urlpatterns = [
    ...
    path('blog_project_list',blog_project_list,name='blog_project_list')
]
